//JQUERY PLACEHOLDER对IE浏览器的支持，仅支持INPUT及TEXTAREA
(function(window, document, $) {

	var isInputSupported = 'placeholder' in document.createElement('input'), isTextareaSupported = 'placeholder' in document
