	...
	b.prototype = {
		...
		selectItem : function(e) {
			...
			if (this.options.selectable == false) {
				//2014-04-02陈小佩增加
				//----增加内容开始
				this.$element.trigger("click", d.data());
				//----增加内容结束
				return
			}
		...
		/*2014-04-04 吴敬磊 展开所有folder*/
		openFolder : function(){
			var tree = this;
			var e = this.$element.find(".tree-folder-header");
			e.each(function(index,element){
				if (index != 0){
					var ico = $(element).find("i");
					if ("icon-plus" == $(ico).attr("class")){
						var rs = tree.selectFolder($(element));
					}
				}
			});
		},
		/*2014-04-04 吴敬磊 关闭所有folder*/
