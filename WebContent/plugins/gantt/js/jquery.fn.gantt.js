    ...
    $.fn.gantt = function (options) {
        ...
        */
        ...
        var core = {
            ...
            leftPanel: function (element) {
                ...
                var ganttLeftPanel = $('<div class="leftPanel"/>')
                    .append($('<div class="gantt-row spacer"/>')
                    .css("height",  24 * element.headerRows + "px")
                    .css("width", tools.getCellSize(element) * 3 + "px"));

                var entries = [];
                $.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage && i < (element.pageNum * settings.itemsPerPage + settings.itemsPerPage)) {
                        entries.push('<div class="gantt-row name gantt-row' + i + (entry.desc ? '' : ' fn-wide') + '" id="rowheader' + i + '" offset="' + i % settings.itemsPerPage * tools.getCellSize(element)
                            + '" style="height: ' + (settings.height + 1) + 'px;">');
                        entries.push('<span class="fn-label' + (entry.cssClass ? ' ' + entry.cssClass : '') + '">' + (entry.name || '') + '</span>');
                        entries.push('</div>');

                        if (entry.desc) {
                            entries.push('<div class="gantt-row desc gantt-row' + i + ' " id="RowdId_' + i + '" data-id="' + entry.id + '">');
            ...
            dataPanel: function (element, width) {
                ...
                dataPanel.click(function (e) {
                    ...
                    switch (settings.scale) {
                        case "weeks":
                            corrY = tools.getCellSize(element) * 2;
                            break;
                        case "months":
                            corrY = tools.getCellSize(element);
                            break;
                        case "hours":
                            corrY = tools.getCellSize(element) * 4;
                            break;
                        case "days":
                            corrY = tools.getCellSize(element) * 3;
                            break;
                        default:
                            corrY = tools.getCellSize(element) * 2;
                            break;
                    ...
                    corrY -= Math.floor(tools.getCellSize(element) / 2);
                    */
            ...
            rightPanel: function (element, leftPanel /* <- never used? */) {
                ...
                var yearArr = ['<div class="gantt-row"/>'];
                var daysInYear = 0;

                var monthArr = ['<div class="gantt-row"/>'];
                var daysInMonth = 0;
                ...
                switch (settings.scale) {
                    ...
                    case "hours":
                        ...
                        for (var i = 0, len = range.length; i < len; i++) {
                            ...
                            if (rfy !== year) {
                                yearArr.push(
                                    ('<div class="gantt-row header year" style="width: '
                                        + tools.getCellSize(element) * daysInYear
                            ...
                            if (rm !== month) {
                                monthArr.push(
                                    ('<div class="gantt-row header month" style="width: '
                                    + tools.getCellSize(element) * daysInMonth + 'px"><div class="fn-label">'
                            ...
                            if (rgetDay !== getDay) {
                                ...
                                dayArr.push('<div class="gantt-row date ' + day_class2 + '" '
                                        + ' style="width: ' + tools.getCellSize(element) * hoursInDay + 'px;"> '
                                        + ' <div class="fn-label">' + day.getDate() + '</div></div>');
                                dowArr.push('<div class="gantt-row day ' + day_class2 + '" '
                                        + ' style="width: ' + tools.getCellSize(element) * hoursInDay + 'px;"> '
                            ...
                            horArr.push('<div class="gantt-row day '
                                    + day_class
                                    + '" id="dh-'
                                    + rday.getTime()
                                    + '"  offset="' + i * tools.getCellSize(element) + '" repdate="' + rday.getRepDate()
                                    + ' style="width: ' + tools.getCellSize(element) + 'px;"><div class="fn-label">'
                                    + rday.getHours()
                                    + '</div></div>');
                        }
                        ...
                        yearArr.push(
                            '<div class="gantt-row header year" style="width: '
                            + tools.getCellSize(element) * daysInYear + 'px;"><div class="fn-label">'
                            + year
                            + '</div></div>');
                        ...
                        dayArr.push('<div class="gantt-row date ' + day_class + '" '
                                + ' style="width: ' + tools.getCellSize(element) * hoursInDay + 'px;"> '
                                + ' <div class="fn-label">' + day.getDate() + '</div></div>');

                        dowArr.push('<div class="gantt-row day ' + day_class + '" '
                                + ' style="width: ' + tools.getCellSize(element) * hoursInDay + 'px;"> '
                                + ' <div class="fn-label">' + settings.dow[day.getDay()] + '</div></div>');

                        var dataPanel = core.dataPanel(element, range.length * tools.getCellSize(element));


                        // Append panel elements
                        dataPanel.append(yearArr.join(""));
                        dataPanel.append(monthArr.join(""));
                        dataPanel.append($('<div class="gantt-row"/>').html(dayArr.join("")));
                        dataPanel.append($('<div class="gantt-row"/>').html(dowArr.join("")));
                        dataPanel.append($('<div class="gantt-row"/>').html(horArr.join("")));
                    ...
                    case "weeks":
                        ...
                        yearArr = ['<div class="gantt-row"/>'];
                        monthArr = ['<div class="gantt-row"/>'];
                        var year = range[0].getFullYear();
                        var month = range[0].getMonth();
                        var day = range[0];
                        ...
                        for (var i = 0, len = range.length; i < len; i++) {
                            ...
                            if (rday.getMonth() !== month) {
                                monthArr.push(
                                    ('<div class="gantt-row header month" style="width:'
                                       + tools.getCellSize(element) * daysInMonth
                                       + 'px;"><div class="fn-label">'
                                       + settings.months[month]
                                       + '</div></div>'));
                                month = rday.getMonth();
                            ...
                            // Fill weeks
                            dayArr.push('<div class="gantt-row day wd" '
                                    + ' id="' + rday.getWeekId() + '" offset="' + i * tools.getCellSize(element) + '" repdate="' + rday.getRepDate() + '"> '
                    ...
                    case 'months':
                        ...
                        for (var i = 0, len = range.length; i < len; i++) {
                            ...
                            daysInYear++;
                            monthArr.push('<div class="gantt-row day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="'
                                + i * tools.getCellSize(element) + '" repdate="' + rday.getRepDate()
                                + '" style="width: ' + tools.getCellSize(element) + 'px;">' + (1 + rday.getMonth()) + '</div>');
                        }
                    ...
                    default:
                        ...
                        for (var i = 0, len = range.length; i < len; i++) {
                            ...
                            dayArr.push('<div class="gantt-row date ' + day_class + '" '
                                    + ' id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize(element) + '" repdate="' + rday.getRepDate() + '"> '
                        ...
                        dataPanel.append(yearArr.join(""));
                        dataPanel.append(monthArr.join(""));
                        dataPanel.append($('<div class="gantt-row" style="margin-left: 0;" />').html(dayArr.join("")));
                        dataPanel.append($('<div class="gantt-row" style="margin-left: 0;" />').html(dowArr.join("")));
                            ...
                            .append($('<div class="nav-slider-left" />')
                                ...
                                */
                                ...
                                .append($('<button type="button" class="nav-link nav-prev-week"/>')
                                    ...
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                                            core.navigateTo(element, tools.getCellSize(element) * 8);
                                        } else if (settings.scale === 'days') {
                                            core.navigateTo(element, tools.getCellSize(element) * 30);
                                        } else if (settings.scale === 'weeks') {
                                            core.navigateTo(element, tools.getCellSize(element) * 12);
                                        } else if (settings.scale === 'months') {
                                            core.navigateTo(element, tools.getCellSize(element) * 6);
                                        }
                                    }))
                                .append($('<button type="button" class="nav-link nav-prev-day"/>')
                                    ...
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                                            core.navigateTo(element, tools.getCellSize(element) * 4);
                                        } else if (settings.scale === 'days') {
                                            core.navigateTo(element, tools.getCellSize(element) * 7);
                                        } else if (settings.scale === 'weeks') {
                                            core.navigateTo(element, tools.getCellSize(element) * 4);
                                        } else if (settings.scale === 'months') {
                                            core.navigateTo(element, tools.getCellSize(element) * 3);
                                        }
                                    })
                                )
                                */
                ...
                // Button navigation is provided by setting `settings.navigation='buttons'`
                    ...
                    ganttNavigate = $('<div class="navigate" />')
                        ...
                        .append($('<button type="button" class="nav-link nav-prev-day"/>')
                            .html('&lt;')
                            .click(function () {
                                core.navigateTo(element, tools.getCellSize(element));
                            }))
                        .append($('<button type="button" class="nav-link nav-now"/>')
                            .html('&#9679;')
                            .click(function () {
                        ...
                        .append($('<button type="button" class="nav-link nav-next-day"/>')
                            .html('&gt;')
                            .click(function () {
                                core.navigateTo(element, tools.getCellSize(element) * -1);
                            }))
                        .append($('<button type="button" class="nav-link nav-next-week"/>')
                            .html('&gt;&gt;')
                            .click(function () {
            ...
            createProgressBar: function (days, cls, desc, label, dataObj,element) {
                var cellWidth = tools.getCellSize(element);
                        ...
                        $.each(entry.values, function (j, day) {
                            ...
                            switch (settings.scale) {
                                ...
                                case "hours":
                                    ...
                                    var dl = Math.floor((cTo - cFrom) / tools.getCellSize(element)) + 1;
                                    ...
                                    var top = settings.height * 5 + 2 + parseInt(topEl.attr("offset"), 10);
                                    ...
                                    var dl = Math.round((cTo - cFrom) / tools.getCellSize(element)) + 1;
                                    ...
                                    var top = settings.height * 3 + 2 + parseInt(topEl.attr("offset"), 10);
                                    _bar.css({ 'top': top, 'left': Math.floor(cFrom) });
                                ...
                                case "months":
                                    ...
                                    // find row
                                    var topEl = $(element).find("#rowheader" + i);
                                    var top = 48 + 2 + settings.height * (i);
                                    _bar.css({ 'top': top, 'left': Math.floor(cFrom),'height':settings.height - 4 });
                                ...
                                default:
                                    ...
                                    var top = settings.height * 4 + 2 + parseInt(topEl.attr("offset"), 10);
                                    _bar.css({ 'top': top, 'left': Math.floor(cFrom) });
        ...
        var tools = {
            ...
            _getCellSize: null,
            getCellSize: function (element) {
                if (!tools._getCellSize){
                    var cellSize = parseInt($("#"+element.id).width() / tools.parseMonthsRange(element.dateStart, element.dateEnd).length) + 1;
                    if (cellSize < parseInt(settings.fullWidth / 50)){
                        cellSize = parseInt(settings.fullWidth / tools.parseMonthsRange(element.dateStart, element.dateEnd).length) + 1;
                    }
                    tools._getCellSize = cellSize;
                }
            ...
            getPageHeight: function (element) {
                return element.pageNum + 1 === element.pageCount ? element.rowsOnLastPage * tools.getCellSize(element) : settings.itemsPerPage * tools.getCellSize(element);
            },
            ...
            getProgressBarMargin: function () {
                if (!tools._getProgressBarMargin && tools._getProgressBarMargin !== 0) {
                    $("body").append(
                        $('<div style="display: none; position: absolute;" id="measureBarWidth" ><div class="fn-gantt"><div class="rightPanel"><div class="dataPanel"><div class="gantt-row day"><div class="bar" /></div></div></div></div></div>')
                    );
