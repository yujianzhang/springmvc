...
<%@ include file="/common/taglibs.jsp"%>
	...
	<link rel="stylesheet" href="${contextPath}/assets/css/date-time-picker/bootstrap-datetimepicker.min.css"/>
	<link rel="stylesheet" href="${contextPath}/assets/css/date-time-picker/bootstrap-datetimepicker.css"/>
	...
	<script src="${contextPath}/assets/js/date-time-picker/bootstrap-datetimepicker.min.js"></script>
	<script src="${contextPath}/assets/js/date-time-picker/locales/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	<!-- 自定义JS和CSS -->
	<script src="${contextPath}/js/common.js?version=${jsVersion}"></script>
	<script src="${contextPath}/js/common/jquery.cookie.js"></script>
	<link rel="stylesheet" href="${contextPath}/css/common.css" />
	<script type="text/javascript" src="${contextPath}/assets/js/json2.js"></script>
<%-- 	<script type="text/javascript" src="${contextPath}/assets/js/jquery.cookies.2.2.0.min.js"></script> --%>
